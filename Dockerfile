...
RUN useradd -m -s /bin/bash -N -u $CMAQ_UID $CMAQ_USER && \
    ...
    echo "export LD_LIBRARY_PATH=/usr/local/lib" >> /home/$CMAQ_USER/.bashrc && \
    echo "export compiler=gcc" >> /home/$CMAQ_USER/.bashrc && \
    echo "export MPIVERSION=openmpi" >> /home/$CMAQ_USER/.bashrc
